...
$tinybrowser['path']['image'] = '/uploads/tiny/images/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/uploads/tiny/media/'; // Media files location
$tinybrowser['path']['file']  = '/uploads/tiny/files/'; // Other files location
