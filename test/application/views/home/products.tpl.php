...
<div class="clr"></div>
<div style="width:800px; height:200px; margin:0 0 0 17px;"><img src="<?php echo base_url() ?>images/hostingfree.png">
<div style="width:800px; height:100px;"><img src="<?php echo base_url() ?>images/seo.png">
        ...
        <div class="SR">
            <div class="Headingarea_pro">
                ...
                <?php 
                    if(@$m_row['price'] > 0)
                    {
                        echo ' Starting at $'.@$m_row['price'];
                    }
                    if(@$m_row['platform_cost'] > 0)
                    {
                        echo ' Platform Cost $'.@$m_row['platform_cost'];
                    }
                    if(@$m_row['insall_charge'] > 0)
                    {
                        echo ' Istallation $'.@$m_row['insall_charge'];
                    }
