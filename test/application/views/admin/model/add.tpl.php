...
<form action="" enctype="multipart/form-data" method="post">
    ...
    <input type="text" id="mname" name="mname" value="<?php echo set_value('mname'); ?>" class="input-medium"/>

    <label>Model Phone Number <span class="req">*</span></label>
    <input type="text" id="mphno" name="mphno" value="<?php echo set_value('mphno'); ?>" class="input-medium"/>
     
    <label>Catagory Name <span class="req">*</span></label>
    <p>
        <select style="width: 400px; display: block;" multiple="multiple" name="catagory[]" id="catagory">
    ...
    <textarea cols="10" rows="3" name="mdetails" id="mdetails" ><?php echo set_value('mdetails'); ?></textarea>
