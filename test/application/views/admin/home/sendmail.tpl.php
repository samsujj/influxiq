                ...
                <div class="loginsection">
                    <div class="login_con">
                        ...
                        <form id="login-form" action="" method="post">
                            ...
                            <label><?php echo $send_mail; ?></label>
                            <!-- <input type="text" id="username" name="username" class="input-medium"  /> -->
                            <div class="clear"></div>

                            <label for="password">Acces Code&nbsp;</label>
                            <input id="acccode" name="acccode" class="input-medium" type="text"  />
                            <div class="clear"></div>
                            &nbsp;&nbsp;&nbsp;&nbsp;Enter Access Code Here From Your Email
                            <div class="clear"></div>
