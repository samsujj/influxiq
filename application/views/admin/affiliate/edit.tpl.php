...
//echo date("m/d/Y",$m_send_data[0]['t_aff_time']); exit;
$edit_date=date_format(date_create($m_send_data[0]['t_aff_time']),'m/d/Y');
 ?>
<script>
    jQuery(function(){
            ...
            <div class="add_detbg">
                <form id="formID" action="" method="post">
                    <div class="pro_add">
                        ...
                        <div class="form_div">
                            <input type="hidden" name="val1" value="<?php echo set_value('val1', $m_send_data[0]['i_aff_id']); ?>"> 
                            ...
                            <div class="fild_text"><input id="afname" name="afname" type="text" class="validate[required] text-input" class1="text_fild" value="<?php echo set_value('afname', $m_send_data[0]['s_aff_name']); ?>" /></div>
                            <div class="clr"></div>
                        </div>
                        <div class="form_div">
                            ...
                            <div class="fild_text"><input id="afemail" name="afemail" type="text" class="validate[required,custom[email]] text-input" class1="text_fild" value="<?php echo set_value('afname', $m_send_data[0]['s_aff_email']); ?>" /></div>
                            <div class="clr"></div>
                        </div>
                        <div class="form_div">
                            <div class="fild_name"><span class="red">*</span>Date of Affiliation :</div>
                            <div class="fild_text"><input name="doa" id="doa" type="text" class="validate[required] text-input" class1="text_fild" value="<?php echo set_value('doa', $edit_date); ?>" readonly="readonly" /></div>
                            <div class="clr"></div>
                        </div>      
                        <div class="form_div">
                            <div class="fild_name"><span class="red">*</span>Product Affiliate Code :</div>
                            <div class="fild_text"><input id="afurl" name="afurl" type="text" class="validate[required] text-input" class1="text_fild" value="<?php echo set_value('afurl',$m_send_data[0]['s_aff_url']); ?>" /></div>
                        ...
                        <div class="form_div">
                            ...
                            <div class="fild_text"><input id="asfurl" name="asfurl" type="text" class="validate[required] text-input" class1="text_fild" value="<?php echo set_value('asfurl',$m_send_data[0]['s_seo_aff_url']); ?>" /></div>
