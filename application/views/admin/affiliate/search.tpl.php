...
<div id="yy" style="display:block; width: 200px; height:90px; float: left; background:#ccc; margin:5px 10px;" >
    ...
    <div id="d_clip_container"  style="position:relative; width: 145px;">
        <div id="d_clip_button" style="width: 145px; background: #333; color: #fff; margin:5px 10px 5px 28px; font-size:10px; text-transform:uppercase; text-align: center;" class="my_clip_button"><b>Copy To Clipboard</b></div>
    </div>  
    ...
    <div id="content">
        ...
        <div class="content_block">
            ...
            <div style="margin: 50px 0 0 0;">
                ...
                <form id="formID1" action="<?php echo admin_url(); ?>affiliate/listing" method="post" >
            ...
            <div class="but3" style="margin-bottom:10px;"><a href="<?php echo admin_url(); ?>affiliate/download1" id="select_admin">CSV Download</a></div>
