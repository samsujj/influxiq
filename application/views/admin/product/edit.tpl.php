                    ...
                    <div id="form_2"  class="dForm" >
                        ...
                        <input type="hidden" name="cat_id" value="<?php echo $category_list[0]['id'] ?>">
                            ...
                            <div class="form_div">
                                <div class="fild_name"><span class="red">*</span>Product Description :</div>
                                <div class="fild_text">
                                    <textarea name="product_desc" id="product_desc" style="height: 100px; width: 294px;" class="validate[required] text-input"><?php echo set_value('product_desc',put_safe($m_dataset[0]['description']))?></textarea>
                                </div>
                                <div class="clr"></div>
                            </div>      
                            <div class="form_div">
