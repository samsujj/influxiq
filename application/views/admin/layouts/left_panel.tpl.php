...
<div id="sidebar">                   
                    <ul class="nav">
                     ...
                     <li><a class="headitem item5" href="#">Order Management</a>
                            <ul class=<?php echo ($s_menu_id == 'menu_order')?'opened':'';?>>
                                <li class="<?php echo ($s_menu_id == 'menu_order' && $s_sub_menu_id=='list_order')?'current':''; ?>"><a href="<?php echo admin_url() ?>order">List Order</a></li>
                             <?php /*  
                        ...
                        <li><a class="headitem item4" href="#">Author Lead Management</a>
                            <ul class=<?php echo ($s_menu_id == 'menu_auth_lead')?'opened':'';?>>                            
                                <li class="<?php echo ($s_menu_id == 'menu_auth_lead' && $s_sub_menu_id=='list_auth_lead')?'current':''; ?>"><a href="<?php echo admin_url() ?>authlead/listing">List of Leads</a></li>
                            </ul>
                        </li>
