...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div class="header_contain">
            <div class="main_wrapper"> MARKETING <span>AND</span> DESIGNING <span>WEBSITES FOR AUTHORS</span>
                <!--   form_top_img-->
        ...
        <div class="top_body">
            <div class="main_wrapper">
                ...
                <div class="top_right_contain">
                    <div class="form_top"> Fill THIS OUT<br />
                        & </div>
                ...
                <h2>Excel Yourself as an Author, SEE BELOW!</h2>
            </div>
        </div>
        <!--end top_body-->
        <!--middle_body-->
            ...
            <div class="main_wrapper">
                ...
                <div class="right_side">
                    <div class="contain"> <strong> MANAGE YOUR BLOGS</strong> <img src="<?php echo base_url(); ?>authskin/images/blog.png" alt="" />
                        <p>As a writer one of the best ways to connect with your fans, fellow authors and industry professionals is directly through your personal blog.  It is important that you put your personality and point of view into words beyond just your work as an author.  Fans love reading their favorite authors blog and feeling like they have an intimate connection with their life.</p>
                    </div>
                    <div class="contain"> <strong> MANAGE&nbsp;YOUR&nbsp;SOCIAL&nbsp;MEDIA&nbsp;TOOLS</strong> <img src="<?php echo base_url(); ?>authskin/images/social_media.png" alt="" />
                        <p>Social Media is critical to having a successful online web presence.  Social sites are at the top of the most visited on the internet.  For an Author social media sites like facebook can be one of the most effective tools to connecting with a fan base.   We make connecting over social media very simple through for you and your fans directly through your website. </p>
                    </div>
                    <div class="contain"> <strong>MANAGE YOUR MEDIA</strong> <img src="<?php echo base_url(); ?>authskin/images/media.png" alt="" />
                        <p>You can put so much more into your website than you would expect! If you have video, or any pictures that you would like to add to your site you can do all of that on your new site.  Adding video and pictures of you as a writer brings flare and life to your web presence. You can even add video to YouTube then create a library right on your site!</p>
                    </div>
                </div>
                <div class="clear"></div>
            </div>
