...
<script type="text/javascript">
 ...
 //     alert(jQuery("#pop").height());   
      ...
      function(result)
      {
        if($(".popcontainer-white").children('input').attr('type_id')==result){
            $(".popcontainer-white").children('input').css('display','none');
                                        ...
                                        <tr>
										   ...
										   <table width="98%" cellspacing="0" cellpadding="0" align="center" style="border-top:#d2a681 solid 2px;">
										      ...
										      <tr>
                                                                            ...
                                                                            <tr>
                                                                                <td height="35" style="text-align:center"><a href="javascript:void(0);" <?php if(!is_plat_cart($cart1)){ ?> onclick="showpopupdef(this)" <?php }else { if(count($product[1]['packages']) > 1) { ?> onclick="showpopup1(this)" <?php }else {  ?> onclick="showpopup(this)"<?php } } ?>  product_id="<?php echo @$product[1]['id']; ?>" pac="<?php echo @$product[1]['mId']; ?>"><img width="99" height="28" src="<?php echo base_url(); ?>images/getstarted.jpg" alt="" /></a></td>
                                                                            </tr>
										      ...
										      <tr>
                                                                            ...
                                                                            <tr>
                                                                                <td height="35" style="text-align:center"><a href="javascript:void(0);" <?php if(!is_plat_cart($cart1)){ ?> onclick="showpopupdef(this)" <?php }else { if(count($product[2]['packages']) > 1) { ?> onclick="showpopup1(this)" <?php }else { ?> onclick="showpopup(this)"<?php } } ?>  product_id="<?php echo @$product[2]['id']; ?>" pac="<?php echo @$product[2]['mId']; ?>"><img width="99" height="28" src="<?php echo base_url(); ?>images/getstarted.jpg" alt="" /></a></td>
                                                                            </tr>
										      ...
										      <tr>
                                                                            ...
                                                                            <tr>
                                                                                <td height="35" style="text-align:center"><a href="javascript:void(0);" <?php if(!is_plat_cart($cart1)){ ?> onclick="showpopupdef(this)" <?php }else { if(count($product[3]['packages']) > 1) { ?> onclick="showpopup1(this)" <?php }else {   ?> onclick="showpopup(this)"<?php } } ?>  product_id="<?php echo @$product[3]['id']; ?>" pac="<?php echo @$product[3]['mId']; ?>"><img width="99" height="28" src="<?php echo base_url(); ?>images/getstarted.jpg" alt="" /></a></td>
                                                                            </tr>
										      ...
										      <tr>
                                                                            ...
                                                                            <tr>
                                                                                <td height="35" style="text-align:center"><a href="javascript:void(0);"<?php if(!is_plat_cart($cart1)){ ?> onclick="showpopupdef(this)" <?php }else { if(count($product[4]['packages']) > 1) { ?> onclick="showpopup1(this)" <?php }else {  ?> onclick="showpopup(this)"<?php } } ?> product_id="<?php echo @$product[4]['id']; ?>" pac="<?php echo @$product[4]['mId']; ?>"><img width="99" height="28" src="<?php echo base_url(); ?>images/getstarted.jpg" alt="" /></a></td>
                                                                            </tr>
                                ...
                                <td>
                                    <table width="100%" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                            ...
                                            <td width="118" bgcolor="#e0e0e0" style="text-align:center">5 To 7 Pages</td>
                                            <td width="118" bgcolor="#e0e0e0" style="text-align:center"><?php /*1 To 2 */ ?>7 To 15 Pages</td>
                                            <td width="118" bgcolor="#e0e0e0" style="text-align:center"><?php /*7 To 10*/ ?>15 To 20 Pages</td>
                                            <td width="118" bgcolor="#e0e0e0" style="text-align:center">Additional Pages</td>
                                        </tr>
